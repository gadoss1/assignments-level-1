...
const sortedOfAge = peopleArray.filter(peopleArray=> peopleArray.age >= 18 && peopleArray.age <= 100)

console.log(sortedOfAge)

const sortedByLName = sortedOfAge.lastName.sort()

console.log(sortedByLName)

const nameReduction = sortedByLName.reduce(function(final, people){
    final.push(people.firstName + " " + people.lastName)
    return final
}, [])
